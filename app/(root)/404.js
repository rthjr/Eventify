    ...
    return (
        <div className="bg-gray-100 h-screen flex items-center justify-center">
            <div className="text-center flex justify-center items-center gap-8">
                <svg
                    className="emoji-404 animate-spin-slow"
                    ...
                    fill="none"
                >
                    <circle cx="113" cy="113" fill="#FFE585" r="109" className="animate-pulse" />
                    <line
                        fill="none"
                        opacity="0.29"
                        stroke="#6E6E96"
                    ...
                    <line
                        ...
                        y2="245.135"
                    />
                    <circle cx="68.732" cy="93" fill="#6E6E96" r="9" className="animate-pulse" />
                    <path
                        ...
                        opacity="0.24"
                    />
                    <circle cx="156.398" cy="93" fill="#6E6E96" r="9" className="animate-pulse" />
                    <ellipse
                        cx="67.732"
                        cy="140.894"
                        enableBackground="new    "
