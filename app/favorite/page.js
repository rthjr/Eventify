...
export default function Favorite() {
    ...
    return (
        <>
            ...
            <div>
                <h2 className="text-center font-bold text-lg my-11">My Favorite</h2>
                <div className="w-full h-auto flex justify-center">
                    <div className="w-10/12 mb-20 flex">
                                    ...
                                    <div className="h-auto flex w-full justify-center">
                                        <div className="grid grid-cols-1 gap-9">
                                            {filteredEvents.slice(0, visibleCount).map(event => {
                                                ...
                                                return (
                                                    <div key={id} className='w-auto h-auto rounded-lg shadow-lg bg-gray-200 flex justify-between gap-4 p-4'>
