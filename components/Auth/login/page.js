                            ...
                            <form onSubmit={handleSignIn}>
                                ...
                                <div className="w-full">
                                    ...
                                    <div className="border-2 p-2 rounded-xl border-black mb-2 w-full">
                                        <input className="border-none outline-none w-full" type="password" required placeholder="Enter your Password..." value={password} onChange={(e) => setPassword(e.target.value)} />
                                        {/* icon */}
                                    </div>
                                </div>
                                ...
                                <button className="p-3 bg-customPurple-default rounded-xl text-white border-none mb-4 hover:bg-customPurple-hover w-full">Login</button>
